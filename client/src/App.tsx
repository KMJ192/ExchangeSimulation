      ...
      <BrowserRouter>
        <Switch>
          ...
          <Route
            path={login_page}
            exact
            component={Auth(LoginContainer, true, pageCaseLogined)}
          />
          <Route
            path={user_register_page}
            exact
            component={Auth(UserRegisterContainer, true, pageCaseLogined)}
          />
          <Route
            path={user_patch_page}
            exact
            component={Auth(UserPatchContainer, true, paceCaseUserPatch)}
          />
